...
INSERT INTO t_tache_tac (tac_nom, usr_mail)
VALUES ('Faire fiches de révision', 'erastegeorgia@gmail.com');

--modifier valeurs en fonction des id des taches & matières
...
DELETE FROM t_matiere_mat WHERE mat_id=4;
